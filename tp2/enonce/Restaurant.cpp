...
// Ici nous allons faire un constructeur par copie de type "deep copy"
		...
		while (!file.eof()) {
			...
			if (ligne == "-TABLES") {
				while (!file.eof()) {
					...
					operator+=(*(new Table(id, nbPersonnes)));
...
// prenant en paramètre un pointeur à une table, permettant d’ajouter une table au restaurant
...
//{
//	cout << "entree dans fonction----------jhjhjhjhjhjhjhjhjhjhjhjhgfgfgfgf!" << endl;
//	return (restaurant1.chiffreAffaire_ < restaurant2.chiffreAffaire_);
//}
